        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form role="form" class="form-horizontal" action="{{ URL::route('product.index') }}"
                              method="get">
                            <!-- text input -->
                            <div>
                                <div class="col-xs-6">
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($products as $product)
                                <tr class="body-table">
                                    ...
                                    <td>{{ $number++ }}</td>
                                    <td class="text-left">
                                        <a href="{{ URL::route('product_detail', ['slug' => $product->slug, 'id' => $product->id]) }}"
                                           target="_blank">
                                    ...
                                    <td>
                                        <a href="{{ URL::route('product.copy', $product->id) }}"
                                           class="btn btn-block btn-success btn-xs">Copy</a>
                                        <a href="{{ URL::route('product.edit', $product->id) }}"
                                           class="btn btn-block btn-warning btn-xs">Sửa</a>
